...
export default function TemplatesEditPage() {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-foreground">Edit Template</h1>
      <p className="text-sm text-muted-foreground">
        Templates são derivados automaticamente do DNA Object e reconstruídos via Rebuild. Edição manual não está disponível nesta versão.
      </p>
